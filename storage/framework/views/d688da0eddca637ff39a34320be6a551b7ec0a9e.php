    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="card-body">
                  <form id="form-edit-data" data-id="" class=" form-vertical"  data-action="<?php echo e(route('showroom.update', Auth::guard('showroom')->user()->id)); ?>" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xamp\htdocs\si_ahp_motorbekas\resources\views/showroom/form-edit-profile.blade.php ENDPATH**/ ?>